...
const tldrSummary =
  "We needed one consistent way to measure how usable the key flows were across multiple apps and sites. We built a repeatable benchmarking system in a shared tracker so teams can identify key areas of interest over time.";

const goalText =
  "To create a repeatable usability benchmarking system that identifies the highest-impact problem areas and tracks measurable improvement over time, so limited resources can be allocated to the highest impact work.";

export default function CaseStudy2Page() {
  return (
    <div className="min-h-screen bg-background overflow-y-auto">
      <CaseStudyHero2 titleParts={titleParts} avatarImage={avatarImage} />
