    ...
    <div className="w-full py-4">
      <svg viewBox="0 0 500 300" className="w-full h-auto">
        ...
        <g transform="translate(100, 80)">
          ...
          />
          <text y="-35" textAnchor="middle" className="text-sm font-display fill-[#343434]">User Demographics</text>
          <text y="-22" textAnchor="middle" className="text-sm font-display fill-[#343434]">and Viewing Habits</text>
        ...
        <g transform="translate(250, 200)">
          <polygon 
            ...
            className="text-foreground"
          />
          <text y="40" textAnchor="middle" className="text-sm font-display fill-[#343434]">Engaging in Content</text>
        ...
        <g transform="translate(400, 80)">
          ...
          <text y="-35" textAnchor="middle" className="text-sm font-display fill-[#343434]">Aggregated Watch</text>
          <text y="-22" textAnchor="middle" className="text-sm font-display fill-[#343434]">Experiences</text>
