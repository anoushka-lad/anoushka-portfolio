  ...
  return (
    <div className="flex justify-center py-8">
      <div className="relative w-80 h-80">
        ...
        <span className="absolute top-[8%] left-[22%] font-serif text-sm text-foreground -rotate-45">Key Insights</span>
        <span className="absolute top-[8%] right-[18%] font-serif text-sm text-foreground rotate-45">Viewing Habits</span>
        <span className="absolute top-[35%] right-[2%] font-serif text-sm text-foreground rotate-[70deg]">Goals</span>
        <span className="absolute bottom-[25%] right-[2%] font-serif text-sm text-foreground rotate-[110deg]">Experiences</span>
        <span className="absolute bottom-[8%] right-[25%] font-serif text-sm text-foreground rotate-[150deg]">Opportunities</span>
        <span className="absolute bottom-[8%] left-[32%] font-serif text-sm text-foreground -rotate-[150deg]">Needs</span>
        <span className="absolute top-[35%] left-[-8%] font-serif text-xs text-foreground -rotate-[70deg] w-20 text-center leading-tight">Challenges and Pain Points</span>
      </div>
    </div>
  );
};
