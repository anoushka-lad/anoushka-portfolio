...
const Figure2bCS2 = () => {
  ...
  return (
    <ScalingContainer designWidth={880} className="py-0">
        ...
        {users.map((user, i) => {
          ...
          return (
            ...
            >
              ...
              <span
                className="absolute text-[20px] leading-[1.1] font-display text-foreground whitespace-nowrap"
                style={{
      ...
      >
        <motion.h4
          className="font-display text-foreground text-[20px] leading-[1.1] mb-3"
          initial={{ opacity: 0 }}
      ...
      >
        <motion.h4
          className="font-display text-foreground text-[20px] leading-[1.1] mb-5 text-center"
        ...
        <div className="flex flex-col gap-4">
          ...
          >
            ...
            <span className="text-[20px] leading-[1.1] font-display text-foreground">Quantitative<br />metrics</span>
          </motion.div>
          <motion.div
            className="flex items-center gap-3"
            initial={{ opacity: 0, x: 15 }}
          ...
          >
            ...
            <span className="text-[20px] leading-[1.1] font-display text-foreground">Qualitative<br />metrics</span>
          </motion.div>
        </div>
      </motion.div>
      </div>
