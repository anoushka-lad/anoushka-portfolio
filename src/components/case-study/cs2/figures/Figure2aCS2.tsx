  ...
  return (
    <ScalingContainer designWidth={700} className="py-4">
      ...
      <div className="text-center mb-1">
        <p className="font-display text-[16px] leading-[1.1] text-[#343434]">Goal 1</p>
        <p className="font-display text-[16px] leading-[1.1] text-[#343434]/90">
        ...
        {tasks.map((task) => {
          ...
          return (
            <text 
              ...
              className="font-display text-[14px] leading-[1.1] fill-[#343434]"
            >
              {lines.map((line, i) => (
                <tspan 
                  key={i} 
      ...
      <div className="text-center mt-1">
        <p className="font-display text-[16px] leading-[1.1] text-[#343434]">Goal 2</p>
        <p className="font-display text-[16px] leading-[1.1] text-[#343434]/90">
