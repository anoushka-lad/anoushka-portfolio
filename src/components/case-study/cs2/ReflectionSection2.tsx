    ...
    <section className="section-padding">
      <div className="case-column">
        ...
        <div className="space-y-5">
          <div>
            <p className="cs-subheading-l2 mb-2">Small sample size</p>
            <p className="cs-body">
          ...
          <div>
            <p className="cs-subheading-l2 mb-2">Task set as a proxy for the core experience</p>
            <p className="cs-body">
          ...
          <div>
            <p className="cs-subheading-l2 mb-2">Platform coverage can be incomplete at any given time</p>
            <p className="cs-body">
          ...
          <div>
            <p className="cs-subheading-l2 mb-2">SUS/AUS are high-level indicators</p>
            <p className="cs-body">
          ...
          <div>
            <p className="cs-subheading-l2 mb-2">AT protocol simplifies a complex space</p>
            <p className="cs-body">
          ...
          <div>
            <p className="cs-subheading-l2 mb-2">DVF triage is directional and can be subjective</p>
            <p className="cs-body">
          ...
          <div>
            <p className="cs-subheading-l2 mb-2">Quarterly cadence can miss regressions between checkpoints</p>
            <p className="cs-body">
