    ...
    <div className="w-full py-4">
      <svg viewBox="0 0 700 280" className="w-full h-auto">
        ...
        <g transform="translate(140, 100)">
          {/* Label above */}
          <text x="0" y="-55" textAnchor="middle" className="font-display text-[14px] fill-[#343434]">
            User Demographics and
          </text>
          <text x="0" y="-38" textAnchor="middle" className="font-display text-[14px] fill-[#343434]">
            Viewing Habits
          </text>
        ...
        <g transform="translate(350, 200)">
          ...
          {/* Label below */}
          <text x="0" y="42" textAnchor="middle" className="font-display text-[14px] fill-[#343434]">
            Engaging in Content
          </text>
        </g>
