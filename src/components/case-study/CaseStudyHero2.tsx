...
import protractorIllustration from "@/assets/case-study-2-illustration.png";
...
interface CaseStudyHero2Props {
  titleParts: TitlePart[];
  avatarImage?: string;
}

const CaseStudyHero2 = ({ titleParts, avatarImage }: CaseStudyHero2Props) => {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative z-10 px-6 pt-16 pb-8 flex flex-col items-center">
        ...
        >
          <motion.img 
            src={protractorIllustration}
            alt="Protractor illustration"
