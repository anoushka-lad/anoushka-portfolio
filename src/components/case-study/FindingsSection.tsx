        ...
        <div>
          ...
          <div className="mb-12">
            <p className="text-foreground/80 mb-2">
              <em className="font-serif">When do personas prefer to watch their content?</em> (Figure 3a)
            </p>
          ...
          <div className="mb-12">
            <p className="text-foreground/80 mb-2">
              <em className="font-serif">What devices to personas prefer to watch on?</em> (Figure 3b)
            </p>
            <p className="text-foreground/70 text-sm mb-4">
          ...
          <div className="mb-12">
            <p className="text-foreground/80 mb-2">
              <em className="font-serif">Who do personas generally watch content with?</em> (Figure 3c)
            </p>
            <p className="text-foreground/70 text-sm mb-4">
          ...
          <div className="mb-12">
            <p className="text-foreground/80 mb-2">
              <em className="font-serif">How tolerant are personas to ads?</em> (Figure 3d)
            </p>
            <p className="text-foreground/70 text-sm mb-4">
          ...
          <div className="mb-12">
            <p className="text-foreground/80 mb-2">
              <em className="font-serif">What media type do personas prefer to watch?</em> (Figure 3e)
            </p>
            <p className="text-foreground/70 text-sm mb-4">
