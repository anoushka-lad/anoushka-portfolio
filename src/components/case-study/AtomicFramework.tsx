  ...
  return (
    <div className="flex flex-wrap justify-center items-end gap-8 md:gap-12 py-8">
      ...
      <div className="flex flex-col items-center gap-3">
        ...
        <span className="text-sm font-serif text-foreground text-center">Key Moments</span>
      </div>
      ...
      <div className="flex flex-col items-center gap-3">
        ...
        <span className="text-sm font-serif text-foreground text-center">Standardized<br/>Attributes</span>
      </div>
      ...
      <div className="flex flex-col items-center gap-3">
        ...
        <span className="text-sm font-serif text-foreground text-center">Emerging<br/>Patterns</span>
      </div>

      {/* Provisional Personas - Dashed square */}
      <div className="flex flex-col items-center gap-3">
        <div className="w-14 h-14 border-2 border-dashed border-foreground" />
        <span className="text-sm font-serif text-foreground text-center">Provisional<br/>Personas</span>
      </div>

      {/* Personas - Solid square */}
      <div className="flex flex-col items-center gap-3">
        <div className="w-14 h-14 bg-foreground" />
        <span className="text-sm font-serif text-foreground text-center">Personas</span>
      </div>
    </div>
  );
};
