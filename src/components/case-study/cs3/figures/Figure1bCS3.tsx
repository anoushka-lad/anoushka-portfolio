    ...
    <ScalingContainer designWidth={880} className="py-6">
      ...
      <div className="flex flex-col items-center gap-4 shrink-0">
        {tasks.map((task, i) => (
          ...
          >
            <p className="font-display text-foreground text-[22.6px] text-center mb-1.5">
              Task {i + 1}
            </p>
            <div
            ...
            >
              <p className="font-display text-[22.6px] leading-relaxed" style={{ color: "hsl(35 30% 85%)" }}>
                {task}
              </p>
            </div>
          </motion.div>
        ...
        <div className="flex flex-col gap-4">
          {criteria.map((item, i) => (
            ...
            >
              ...
              <span className="text-[22.6px] font-display text-foreground whitespace-pre-line">{item.label}</span>
            </motion.div>
          ))}
        </div>
      </motion.div>
