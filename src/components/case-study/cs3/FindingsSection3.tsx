    ...
    <section className="section-padding">
      <div className="case-column">
        ...
        <div className="cs-content-block">
          <p className="cs-subheading-l1 mb-3">Key Takeaways</p>
          <p className="cs-body">
        ...
        <div className="space-y-5 mb-5">
          <div>
            <p className="cs-subheading-l2 mb-2">Number and Frequency</p>
            <p className="cs-body">
          ...
          <div>
            <p className="cs-subheading-l2 mb-2">Placement and Organisation</p>
            <p className="cs-body">
          ...
          <div>
            <p className="cs-subheading-l2 mb-2">Load Time and Interaction</p>
            <p className="cs-body">
        ...
        <div className="space-y-5">
          <div>
            <p className="cs-subheading-l2 mb-2">BNN Bloomberg</p>
            <p className="cs-body">
          ...
          <div>
            <p className="cs-subheading-l2 mb-2">CBC News</p>
            <p className="cs-body">
          ...
          <div>
            <p className="cs-subheading-l2 mb-2">The Globe and Mail</p>
            <p className="cs-body">
          ...
          <div>
            <p className="cs-subheading-l2 mb-2">CNBC</p>
            <p className="cs-body">
