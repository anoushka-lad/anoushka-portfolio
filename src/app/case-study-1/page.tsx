...
const tldrSummary =
  "Our streaming services lived in separate apps with separate audiences. We built 6 behavioural personas to guide how we design an aggregated watch experience (AWE) that feels like one home without oversimplifying beloved, legacy brands.";

const goalText =
  "To understand our users' viewing behaviours and turn them into actionable design priorities and decisions, so AWE feels simple, intuitive, and easy to navigate.";

export default function CaseStudy1Page() {
  return (
    <div className="min-h-screen bg-background overflow-y-auto">
      <CaseStudyHeroNew titleParts={titleParts} avatarImage={avatarImage} />
